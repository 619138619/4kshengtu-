...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-gradient-to-r from-primary to-accent hover:from-indigo-600 hover:to-violet-600 text-white shadow-lg shadow-indigo-500/20",
    secondary: "bg-surface border border-slate-700 hover:bg-slate-700 text-slate-200",
